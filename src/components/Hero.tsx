        ...
        <div className="flex flex-col justify-center h-full pt-20">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-8 py-4 rounded-full font-semibold flex items-center justify-center gap-3 transition-all duration-300 text-lg shadow-lg"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="border-2 border-white text-white hover:bg-white hover:text-black px-8 py-4 rounded-full font-semibold transition-all duration-300 text-lg backdrop-blur-sm"
            >
              Our Services
            </motion.button>
          </motion.div>
