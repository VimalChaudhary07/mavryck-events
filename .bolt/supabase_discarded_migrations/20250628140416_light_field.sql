/*
  ...
  1. New Features
    - Add event categories and pricing tiers
    - Add user preferences and settings
    - Add event templates for quick setup
    - Add file attachments for events
    - Add event timeline and milestones
    - Add vendor management
    - Add invoice and payment tracking
...
CREATE POLICY "active_events_view_authenticated_select"
  ON active_events_view FOR SELECT
  TO authenticated
  USING (true);
